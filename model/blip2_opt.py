...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        # self.autozijiegou=False
        self.graph_encoder, self.ln_graph = self.init_graph_encoder(gin_num_layers, gin_hidden_dim, gin_drop_ratio,self.zijiegou,self.num_query_token,False)
        ...
        opt_model = "./deepseek/deepseek-1.5b"
