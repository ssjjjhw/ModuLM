...
for i in range(len(train_idx)):
    ...
    #     break
    #data[train_idx[i]]
    os.makedirs("data/solve_data/Combisolv_3d/train/smiles1/"+str(i))
    os.makedirs( "data/solve_data/Combisolv_3d/train/smiles2/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/train/graph1/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/train/graph2/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/train/text/"+str(i))

    smiles1 = data[train_idx[i]][0]
    smiles2 = data[train_idx[i]][1]

    atoms1,coords1 = inner_smi2multicoords(smiles1)
    np.savez("data/solve_data/Combisolv_3d/train/graph1/"+str(i)+'/atoms_coords.npz', atoms=atoms1, coords=coords1)

    atoms2,coords2 = inner_smi2multicoords(smiles2)
    np.savez("data/solve_data/Combisolv_3d/train/graph2/"+str(i)+'/atoms_coords.npz', atoms=atoms2, coords=coords2)

    value = data[train_idx[i]][4]
    # lower, upper = calculate_bounds(value)
    if value>=0:
        text = "The accurate value is +"+str('%.2f'%value)+" or +"+str('%.2f'%value)+";"
    else:
        text = "The accurate value is "+str('%.2f'%value)+" or "+str('%.2f'%value)+";"

    file = open("data/solve_data/Combisolv_3d/train/text/"+str(i)+"/text.txt","w")
    file.write(text)
    file.close()

    file = open("data/solve_data/Combisolv_3d/train/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/solve_data/Combisolv_3d/train/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    print(i)
for i in range(len(valid_idx)):
    ...
    #     break
    #data[train_idx[i]]
    os.makedirs("data/solve_data/Combisolv_3d/valid/smiles1/"+str(i))
    os.makedirs( "data/solve_data/Combisolv_3d/valid/smiles2/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/valid/graph1/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/valid/graph2/"+str(i))
    os.makedirs("data/solve_data/Combisolv_3d/valid/text/"+str(i))

    smiles1 = data[valid_idx[i]][0]
    smiles2 = data[valid_idx[i]][1]
    atoms1,coords1 = inner_smi2multicoords(smiles1)
    np.savez("data/solve_data/Combisolv_3d/valid/graph1/"+str(i)+'/atoms_coords.npz', atoms=atoms1, coords=coords1)

    atoms2,coords2 = inner_smi2multicoords(smiles2)
    np.savez("data/solve_data/Combisolv_3d/valid/graph2/"+str(i)+'/atoms_coords.npz', atoms=atoms2, coords=coords2)
    ...
    file = open("data/solve_data/Combisolv_3d/valid/text/"+str(i)+"/text.txt","w")
    file.write(text)
    file.close()

    file = open("data/solve_data/Combisolv_3d/valid/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/solve_data/Combisolv_3d/valid/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    print(i)
'''
