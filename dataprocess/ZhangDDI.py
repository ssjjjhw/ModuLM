...
for i in range(len(train_idx)):
    if i==1:
        break
    data[train_idx[i]]
    os.makedirs("data/ddi_data/Zhangddi_data3/train/smiles1/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/train/smiles2/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/train/graph1/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/train/graph2/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/train/text/"+str(i))


    data1 = mol_to_graph_data_obj_simple(data[train_idx[i]][2])
    torch.save(data1,"data/ddi_data/Zhangddi_data3/train/graph1/"+str(i)+'/graph_data.pt')
    data1 = mol_to_graph_data_obj_simple(data[train_idx[i]][3])
    torch.save(data1,"data/ddi_data/Zhangddi_data3/train/graph2/"+str(i)+'/graph_data.pt')
    
    smiles1 = data[train_idx[i]][2]
    smiles2 = data[train_idx[i]][3]
    file = open("data/ddi_data/Zhangddi_data3/train/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/ddi_data/Zhangddi_data3/train/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    ...
    text3 = text+'\n'
    file = open("data/ddi_data/Zhangddi_data3/train/text/"+str(i)+"/text.txt","w")
    file.write(text3)
    file.close()
    print(i)
...
for i in range(len(valid_idx)):
    if i==1:
        break
    data[valid_idx[i]]
    os.makedirs("data/ddi_data/Zhangddi_data3/valid/smiles1/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/valid/smiles2/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/valid/graph1/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/valid/graph2/"+str(i))
    os.makedirs("data/ddi_data/Zhangddi_data3/valid/text/"+str(i))


    data1 = mol_to_graph_data_obj_simple(data[valid_idx[i]][2])
    torch.save(data1,"data/ddi_data/Zhangddi_data3/valid/graph1/"+str(i)+'/graph_data.pt')
    data1 = mol_to_graph_data_obj_simple(data[valid_idx[i]][3])
    torch.save(data1,"data/ddi_data/Zhangddi_data3/valid/graph2/"+str(i)+'/graph_data.pt')
    
    smiles1 = data[valid_idx[i]][2]
    smiles2 = data[valid_idx[i]][3]
    file = open("data/ddi_data/Zhangddi_data3/valid/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/ddi_data/Zhangddi_data3/valid/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    ...
    if label == 0:
        ...
        text = "#Drug1 and #Drug2 exhibit drug-drug interaction."
    text3 = text+'\n'
    file = open("data/ddi_data/Zhangddi_data3/valid/text/"+str(i)+"/text.txt","w")
    file.write(text3)
    file.close()
    print(i)
