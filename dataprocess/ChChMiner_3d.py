...
for i in range(len(train_idx)):
    ...
    #     break
    data[train_idx[i]]
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/smiles1/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/smiles2/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/graph1/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/graph2/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/text/"+str(i))

    
    # data1 = mol_to_graph_data_obj_simple(data[train_idx[i]][2])
    # torch.save(data1,"data/ddi_data/ChChMiner_3d/train/graph1/"+str(i)+'/graph_data.pt')
    # data1 = mol_to_graph_data_obj_simple(data[train_idx[i]][3])
    # torch.save(data1,"data/ddi_data/ChChMiner_3d/train/graph2/"+str(i)+'/graph_data.pt')

    smiles1 = data[train_idx[i]][2]
    smiles2 = data[train_idx[i]][3]
    atoms1,coords1 = inner_smi2multicoords(smiles1)
    np.savez("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/graph1/"+str(i)+'/atoms_coords.npz', atoms=atoms1, coords=coords1)

    atoms2,coords2 = inner_smi2multicoords(smiles2)
    np.savez("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/graph2/"+str(i)+'/atoms_coords.npz', atoms=atoms2, coords=coords2)

    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    
    label = data[train_idx[i]][4]
    if label == 0.0:
        text = "The answer is 000."
    elif label == 1.0:
        text = "The answer is 111."
    text3 = text+'\n'
    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/train/text/"+str(i)+"/text.txt","w")
    file.write(text3)
    file.close()
    print(i)
...
for i in range(len(valid_idx)):
    ...
    #     break
    data[valid_idx[i]]
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/smiles1/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/smiles2/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/graph1/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/graph2/"+str(i))
    os.makedirs("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/text/"+str(i))


    # data1 = mol_to_graph_data_obj_simple(data[valid_idx[i]][2])
    # torch.save(data1,"data/ddi_data/ChChMiner_3d/valid/graph1/"+str(i)+'/graph_data.pt')
    # data1 = mol_to_graph_data_obj_simple(data[valid_idx[i]][3])
    # torch.save(data1,"data/ddi_data/ChChMiner_3d/valid/graph2/"+str(i)+'/graph_data.pt')

    smiles1 = data[valid_idx[i]][2]
    smiles2 = data[valid_idx[i]][3]

    atoms1,coords1 = inner_smi2multicoords(smiles1)
    np.savez("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/graph1/"+str(i)+'/atoms_coords.npz', atoms=atoms1, coords=coords1)

    atoms2,coords2 = inner_smi2multicoords(smiles2)
    np.savez("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/graph2/"+str(i)+'/atoms_coords.npz', atoms=atoms2, coords=coords2)

    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/smiles1/"+str(i)+"/text.txt","w")
    file.write(smiles1)
    file.close()
    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/smiles2/"+str(i)+"/text.txt","w")
    file.write(smiles2)
    file.close()
    ...
    if label == 0.0:
        ...
        text = "The answer is 111."
    text3 = text+'\n'
    file = open("data/ddi_data/ChChMinChChMiner_3d_20_deep/valid/text/"+str(i)+"/text.txt","w")
    file.write(text3)
    file.close()
    print(i)
